...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s vikascoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  vikascoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vikascoin transaction") + "\n" +
              "  vikascoin-tx [options] -create [commands]   " + _("Create hex-encoded vikascoin transaction") + "\n" +
              "\n";
