...
{
    const char* pszTimestamp = "Iam Creating My Own Cryptocurrency In The Day Of 11/08/2022";
    const CScript genesisOutputScript = CScript() << ParseHex("027684710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1660223531, 2000468508, 0x1e0ffff0, 1, 150 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xdc47273f918fe81269e708a8b6ae3a96568ec4248943707b054be68192197bf0"));
        assert(genesis.hashMerkleRoot == uint256S("0x492cc8328a06c7e8c436588e9da2674d4f1e5eb48bf360479b857a493750ca8d"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("45.79.123.118", "45.79.123.118", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("vikascointools.com", "dnsseed.vikascointools.com"));
        //vSeeds.push_back(CDNSSeedData("vikascoinpool.org", "dnsseed.vikascoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xdc47273f918fe81269e708a8b6ae3a96568ec4248943707b054be68192197bf0"))
        ...
        chainTxData = ChainTxData{
            ...
            1660223531, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1660223531, 822148, 0x1e0ffff0, 1, 150 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x3beadb62718e0f3b44e7680c4b3e945be6a75666404d271f0826f7cdb86b7570"));
        assert(genesis.hashMerkleRoot == uint256S("0x492cc8328a06c7e8c436588e9da2674d4f1e5eb48bf360479b857a493750ca8d"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("45.79.123.118", "45.79.123.118"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.vikascoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x3beadb62718e0f3b44e7680c4b3e945be6a75666404d271f0826f7cdb86b7570")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1660223531, 1, 0x207fffff, 1, 150 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa284c7d719305e60918e377fad14de151bd65dcfd1fb4448e5789dcaaaf6326e"));
        assert(genesis.hashMerkleRoot == uint256S("0x492cc8328a06c7e8c436588e9da2674d4f1e5eb48bf360479b857a493750ca8d"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xa284c7d719305e60918e377fad14de151bd65dcfd1fb4448e5789dcaaaf6326e"))
        };
