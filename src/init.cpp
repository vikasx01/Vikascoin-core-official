...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/vikascoin-project/vikascoin>";
    const std::string URL_WEBSITE = "<https://vikascoin.org>";
